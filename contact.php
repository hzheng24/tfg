...
<body>
                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    <a href="compra.php" class="dropdown-item">Compra</a>
                                </div>
                            </div>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                <p class="m-0"><a href="./index.php">Página principal</a></p>
                <p class="m-0 px-2">-</p>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Contáctanos para cualquier asunto</span></h2>
        </div>
        <div class="row px-xl-5">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        <div class="control-group">
                            <input type="text" class="form-control" id="name" placeholder="Nombre"
                                required="required" data-validation-required-message="Por favor pon tu nombre aquí" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="email" class="form-control" id="email" placeholder="Email"
                                required="required" data-validation-required-message="Por favor pon tu email aquí" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" placeholder="Asunto"
                                required="required" data-validation-required-message="Por favor pon el asunto aquí" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea class="form-control" rows="6" id="message" placeholder="Mensaje"
                                required="required"
                                data-validation-required-message="Pon tu mensaje aquí"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
            ...
            <div class="col-lg-5 mb-5">
                <div class="d-flex flex-column mb-3">
                    <h5 class="font-weight-semi-bold mb-3">Localización de nuestra tienda</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Calle San Benito, 13, Madrid</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>asir202400@estudiantes.salesianasnsp.es</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+34 666 666 666</p>
                </div>
            </div>
        </div>
    </div>
