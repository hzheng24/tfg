...
<body>
    ...
    ?>
        <div class="col-md-12">
            <div class="row pb-3">
                <!--Mostrar todos los productos que tiene en el carrito -->
                <?php
                foreach ($micarrito as $producto) {
                ?>
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <form method="post" action="compra.php">
                            <input type="hidden" name="paginanom" value="carrito.php">
                            <a href="#">
                                <h3 class="text-center">
                                    <?php
                                    // Buscar la ruta para las imagenes
                            ...
                            <div class="card product-item border-0 mb-4">
                                <div class="product-img position-relative overflow-hidden bg-transparent p-0">
                                    <img src="<?php echo $prodruta ?>" style="width:100%" class="img-fluid">
                                </div>
                            ...
                            <input class="btn btn-primary btn-block border-0 py-3" type="submit" value="Eliminar producto" name="eliminar">
                        </form>
                    </div>
                <?php
                }
        ...
        <form method="post" action="compra.php">
            <input class="btn btn-primary btn-block border-0 py-3" type="submit" value="Comprar" name="comprar">
        </form>
        </form>
        </div>
        </div>
