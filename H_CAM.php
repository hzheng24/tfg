    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Descubre nuestra selección de camisetas para mujer, diseñadas para combinar comodidad 
                    y estilo en cada ocasión. Desde básicos versátiles hasta estilos de declaración, nuestras camisetas están confeccionadas con 
                    tejidos de alta calidad y cortes favorecedores para ofrecerte un look impecable. Encuentra tu nueva camiseta favorita entre 
                    una variedad de colores, estampados y detalles únicos. </p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    <form method="post" action="añadir_carrito.php">
                        <input type="hidden" name="paginanom" value="H_CAM.php">
