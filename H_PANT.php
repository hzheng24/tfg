...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Pantalones para Hombre</h1>
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Descubre nuestros pantalones vaqueros, diseñados con un ajuste perfecto
                    y fabricados con denim de alta calidad para brindarte comodidad y estilo. Disponibles en varios cortes y lavados,
                    son ideales para cualquier ocasión, desde un look casual hasta uno más elegante.</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row pb-3">
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    ...
                    <input type="hidden" name="paginanom" value="H_PANT.php">
