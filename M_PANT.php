...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Pantalones para Mujer</h1>
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Explora nuestra colección de pantalones para mujer, diseñados para brindarte estilo
                    y comodidad en cada paso. Desde pantalones ajustados hasta pantalones de corte amplio, nuestra variedad de estilos te
                    ofrece opciones para cada ocasión. Confeccionados con tejidos de alta calidad y detalles de moda, nuestros pantalones
                    realzan tu figura y te hacen sentir segura en cualquier situación. Descubre una amplia gama de colores y patrones para expresar tu estilo personal.</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row pb-3">
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    ...
                    <input type="hidden" name="paginanom" value="M_PANT.php">
                        ...
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                ...
                                <button name="agregar" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Añadir al carrito</button>
                            </div>
                        </div>
                    </form>
                </div>
