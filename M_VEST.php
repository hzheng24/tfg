...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Vestidos</h1>
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Explora nuestra exquisita colección de vestidos para mujer,
                    donde el estilo se une a la comodidad para crear looks elegantes y versátiles. Desde estilos casuales
                    hasta diseños sofisticados para ocasiones especiales, cada vestido está confeccionado con atención al detalle
                    y tejidos de alta calidad para realzar tu belleza natural. Ya sea que busques un vestido para el día a día o para
                    una ocasión especial, encontrarás el vestido perfecto que refleje tu estilo único.</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row pb-3">
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    ...
                    <input type="hidden" name="paginanom" value="M_VEST.php">
