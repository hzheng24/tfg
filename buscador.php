...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Búsqueda</h1>
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;"></p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['busqueda'])) {
            $busqueda = test_input($_POST['busqueda']);
        }
    }
    $productos = buscador($busqueda);
    ?>
    <div class="col-md-12">
        <div class="row pb-3">
            <?php
