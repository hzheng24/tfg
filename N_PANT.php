...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Pantalones para niño</h1>
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Explora nuestra colección de pantalones para niños, diseñados para acompañarlos
                    en todas sus aventuras. Confeccionados con tejidos cómodos y resistentes, nuestros pantalones ofrecen libertad de movimiento
                    y durabilidad para jugar todo el día. Desde estilos clásicos hasta diseños modernos, encuentra el ajuste perfecto para tu pequeño explorador.</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row pb-3">
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    ...
                    <input type="hidden" name="paginanom" value="N_PANT.php">
