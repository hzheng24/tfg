...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Camisetas para Niño</h1>
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Descubre nuestras camisetas para niños, diseñadas con materiales suaves
                    y duraderos para la máxima comodidad y resistencia. Con una variedad de colores vibrantes y estampados divertidos,
                    nuestras camisetas son perfectas para cualquier ocasión.</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row pb-3">
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    ...
                    <input type="hidden" name="paginanom" value="N_CAMST.php">
