    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Descubre una amplia selección de ropa para mujer, hombre y niños, así como accesorios que complementarán
                     tu estilo único. Desde prendas casuales hasta elegantes atuendos, cada artículo ha sido cuidadosamente seleccionado para garantizar calidad y estilo.
Únete a nuestra comunidad de amantes de la moda y redefine tu estilo con Focus. ¡Explora nuestras colecciones hoy mismo!</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    <form method="post" action="añadir_carrito.php">
                            <input type="hidden" name="paginanom" value="tienda.php">
                        ...
                        <div class="card product-item border-0 mb-4">
                            <div class="product-img position-relative overflow-hidden bg-transparent p-0">
                                <img class="img-fluid w-100" src="<?php echo $producto["ruta"]; ?>?>.png" style="width:100%">
                            </div>
