...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Camisas para Mujer</h1>
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Encuentra tu estilo perfecto con nuestra colección de camisas para mujer.
                    Desde elegantes blusas hasta camisetas casuales, nuestras prendas están diseñadas para realzar tu estilo único.
                    Con tejidos suaves y cortes favorecedores, nuestras camisas ofrecen comodidad y estilo en cada ocasión. Descubre
                    una amplia gama de colores y estampados para expresar tu personalidad con confianza. </p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row pb-3">
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    ...
                    <input type="hidden" name="paginanom" value="M_CAM.php">
