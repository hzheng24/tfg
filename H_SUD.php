...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Sudaderas para Hombre</h1>
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Explora nuestra colección de sudaderas para hombre, perfectas para cualquier ocasión.
                    Confeccionadas con materiales suaves y duraderos, nuestras sudaderas ofrecen comodidad y estilo en una variedad de diseños y colores.
                    Ideales para mantenerte abrigado y con un look moderno, tanto en el gimnasio como en tus días de descanso.</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row pb-3">
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    ...
                    <input type="hidden" name="paginanom" value="H_SUD.php">
