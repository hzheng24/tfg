...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Camisas para Niño</h1>
            <div class="d-inline-flex">
                <p class="m-0" style="font-style: italic;">Nuestras camisas para niños combinan estilo y comodidad, perfectas para cualquier ocasión.
                    Disponibles en una variedad de colores y estampados divertidos, están hechas con tejidos suaves y resistentes que aseguran durabilidad
                    y facilidad de movimiento.</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="row pb-3">
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                    ...
                    <input type="hidden" name="paginanom" value="N_CAM.php">
